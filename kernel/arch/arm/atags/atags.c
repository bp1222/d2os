...
static int parse_cmdline_int(const char *cmdline, char *key)
{
...
void atags_detect(uint32_t *atags)
{
    ...
    while (1)
    {
        ...
        /* Command line */
        case ATAG_CMDLINE:
            cmdline = (const char *)(&tags[2]);

            atag_info.cmdline = cmdline;
